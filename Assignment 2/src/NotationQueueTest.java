...
public class NotationQueueTest {
	...
	public Double one = 21.0, two = 12.34, three = 10.0, four = 34.5, five = 5.0, six = 123.45;
	...
	public void testToStringStudent() throws QueueOverflowException {
		//Use the doubleQ for student tests
		assertEquals("21.012.3410.0", doubleQ.toString());
		doubleQ.enqueue(four);
		assertEquals("21.012.3410.034.5", doubleQ.toString());
		doubleQ.enqueue(five);
		assertEquals("21.012.3410.034.55.0", doubleQ.toString());
	}
